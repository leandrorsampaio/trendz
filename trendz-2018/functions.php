...
function custom_post_type4() {
    ...
    $labels = array(
        'name' => _x('Advertising', 'Post Type General Name', 'text_domain'),
        'singular_name' => _x('Advertising', 'Post Type Singular Name', 'text_domain'),
        'menu_name' => __('Advertising', 'text_domain'),
        'name_admin_bar' => __('Advertising', 'text_domain'),
        'archives' => __('Item Archives', 'text_domain'),
        'parent_item_colon' => __('Parent Item:', 'text_domain'),
        'all_items' => __('All Items', 'text_domain'),
        'add_new_item' => __('Add New Item', 'text_domain'),
    ...
    $args = array(
        'label' => __('advertising', 'text_domain'),
        'labels' => $labels,
